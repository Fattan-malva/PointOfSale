...
class ItemModal {
          ...
          fields: [
            ...
            _RespRow([
              ...
              _Field(
                  ...
                  child: _CurrencyField(
                      controller: costCtrl, hint: '0 (optional)')),
            ]),
            const SizedBox(height: 20),
            _RespRow([
              if (categories.isNotEmpty)
                _buildCategoryPicker(categories, (id) => categoryId = id),
              _Field(
                  label: 'DESCRIPTION',
            ...
            if (allBranches.isNotEmpty) ...[
              ...
              _buildCheckboxGroup(
                ...
                items:
                    allBranches.map((b) => _CheckItem(b.id, b.name)).toList(),
                selected: branchIds,
              ),
            ],
          ],
    ...
    return AppModal.show<Map<String, dynamic>>(
        ...
        AppModalConfig(
          ...
          fields: [
            _RespRow([
              ModalField(
                  controller: nameCtrl, label: 'Item Name', autofocus: true),
  ...
  static Widget _buildCategoryPicker(
    ...
    return _CategoryPicker(
        categories: categories, initial: initial, onSelected: onSelected);
  }
...
class _CategoryPicker extends StatefulWidget {
  ...
  const _CategoryPicker(
      {required this.categories, this.initial, required this.onSelected});
            ...
            children: widget.items.map((item) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        checked ? const Color(0xFFF7F6F3) : Colors.transparent,
