...
class PackageRepository {
  ...
  Future<List<ItemModel>> getPackages(
  ...
  Future<List<PackageDetailModel>> getPackageDetails(
      String packageItemId) async {
    final res = await _api.get('/items/$packageItemId/packages');
    final data =
        res.data['data'] as List<dynamic>? ?? res.data as List<dynamic>;
    return data
        .map((e) => PackageDetailModel.fromJson(e as Map<String, dynamic>))
        .toList();
  }

  Future<PackageDetailModel> addPackageDetail(
      String packageItemId, String itemId, int qty) async {
    final res = await _api.post('/items/$packageItemId/packages',
  ...
  Future<void> removePackageDetail(
      String packageItemId, String detailId) async {
